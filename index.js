...
function animateDiv(myclass, myid) {
  ...
  if (
    ...
    document.getElementById(myid).src = "./assets/rickcallingmorericks.png";
    var snd = new Audio("./assets/rickrollsfx.mp3");
    snd.play();
    setTimeout(function () {
      document.getElementById(myid).src = "./assets/rick.gif";
    }, 1800);
    if (pingus == 1) {
      setTimeout(function () {
